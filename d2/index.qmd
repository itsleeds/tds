...
#| echo: false
#| eval: false
quarto::quarto_render("d2/index.qmd", output_format = "pdf", output_file = "tds-formative-assessment-brief.pdf")
# docx:
quarto::quarto_render("d2/index.qmd", output_format = "docx", output_file = "tds-formative-assessment-brief.docx")
file.rename("docs/tds-formative-assessment-brief.pdf", "formative-assessment-brief.pdf")
file.rename("docs/tds-formative-assessment-brief.docx", "formative-assessment-brief.docx")
system("gh release upload 2025 tds-formative-assessment-brief.pdf")
```
...
**Non-assessed submission deadline**: 18th March 2025

## Submission Method
- A `.zip` file with:
  - A short (5-page max) PDF document.
  - Reproducible code (e.g., `.qmd` file).
  - A maximum zip file size of 10MB (note: you may need to remove large data files from the folder before zipping).
...
2. **Reproducible code** in a `.qmd` file (or another format if justified).
