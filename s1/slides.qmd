...
## Practical 1: Finding a good research question and project set-up

- Questions about the module?
- Break and software installation check
- Thinking of a good research question and discussion
- Data science foundations (guided)
- Focussed work on practical 1
...
try:
  ...
  # This problem was originally designed to teach Excel from the command line:
  # head -n 6 transport-software.csv | tail -n 5 | sort -t, -k5 -rn
  tms = pl.read_csv("transport-software.csv")[:5]
  # Note: polars has a read_excel function, e.g. pl.read_excel("data.xlsx")
  # but here we use the CSV file for consistency
