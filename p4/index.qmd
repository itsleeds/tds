...
![](images/otp_screenshot.png) OTP Web GUI
...
8. Make a route network for driving and plot it using the tmap package. How is is different from just plotting the routes?
...
9. Filter the routes_transit to contain only one route option per origin-destination pair.
...
11. Plot the centrality of the Isle of Wight road network. What can centrality tell you about a road network?

12. Use `dodgr::dodgr_contract_graph` before calculating centrality, how does this affect the computation time and the results?
