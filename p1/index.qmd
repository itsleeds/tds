...
1.  Lecture: an introduction to Transport Data Science (30 min)
    -   See the [slides](https://itsleeds.github.io/tds/s1/slides.html)
...
- Reproduce the code I wrote during this session, e.g. by copy-pasting this code into the console or source editor of RStudio: [github.com/itsleeds/tds/blob/main/s1/s1project/foundations.qmd](https://github.com/itsleeds/tds/blob/main/s1/s1project/foundations.qmd)
