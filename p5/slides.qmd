...
Source: [Geocomputation with R](https://r.geocompx.org/adv-map.html)
...
- Are easy with **tmap** (section [9.3](http://r.geocompx.org/adv-map.html#animated-maps) of geocompr)
