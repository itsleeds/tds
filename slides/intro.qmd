...
#| echo: false
#| eval: false
# Copy self-contained version to OneDrive:
quarto::quarto_render("slides/intro.qmd")
file.copy("docs/slides/intro.html", "~/OneDrive/career/modules/tds/intro.html", overwrite = TRUE)
```
>>>>>>> 21c60dadd8afab33df597e739a9edfba5d586d33
...
::: {.column width="50%"}
![](images/online-teaching-tweet.png)
:::
:::::
...
=======
-   Chapter 13, [Transportation](http://r.geocompx.org/transport.html) of Geocomputation with R, a open book on geographic data in R (available free [online](http://r.geocompx.org/)) (Lovelace et al. 2019)
>>>>>>> 21c60dadd8afab33df597e739a9edfba5d586d33
...
> The leaders were incredibly helpful during
practical sessions and feedback was constructive. I liked having the opportunity to discuss what I had achieved so far with peers,
as this led to the sharing of ideas and insight from other degree disciplines also.
>>>>>>> 21c60dadd8afab33df597e739a9edfba5d586d33
