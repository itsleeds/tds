...
execute:
  message: false
  warning: false
# note: use ctrl+Shift+k to render
---
...
# Commented out because next line is failing
# TODO: fix this issue and re-enable the code.
...
#   5.     └─tmap:::step4_plot(...)
#   6.       ├─base::do.call(...)
#   7.       ├─tmap::tmapLeafletDataPlot(...)
#   8.       ├─tmap:::tmapLeafletDataPlot.tm_data_borders(...)
#   9.       ├─base::NextMethod()
#  10.       └─tmap:::tmapLeafletDataPlot.tm_data_polygons(...)

# Quitting from walking-safety-herefordshire.qmd:67-91 [unnamed-chunk-5]
# Execution halted
