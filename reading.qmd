...
-   [Geocomputation with Python](https://py.geocompx.org/) [@dorman_geocomputation_2025]
    -   Resource for working with geographic data using Python, covering both vector and raster data models, only core reading if you are using Python for the sessions.
...
-   [Introduction to GitHub](https://github.com/skills/introduction-to-github) [@heis_introduction_2025]
    ...
    -   A good starting point for learning how to use GitHub for version control and collaboration. See also the short [GitHub Skills](https://skills.github.com/) courses for a gentle introduction.
